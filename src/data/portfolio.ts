...
export const projectsBase = [
  ...
  },
  {
    ...
    github: '',
    demo: 'https://www.spigotmc.org/resources/simonsays-multi-arena-minigame.136187/',
    docs: 'https://simonsays.blancocl.dev',
    status: 'completed' as const,
    featured: true,
    published: true,
    isNew: true,
  ...
  {
    id: 'npcpro',
    translationKey: 'npcPro',
    image: 'https://images.unsplash.com/photo-1607513746994-51f730a44832?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    technologies: ['Java', 'Spigot API', 'Paper API', 'NPCs', 'YAML', 'Minecraft 1.21-1.26'],
    github: '',
    demo: 'https://www.spigotmc.org/resources/npcpro-a-premium-npcs-for-your-network-servers-1-21-x-26-2.138134/',
    docs: 'https://npcpro.blancocl.dev',
    status: 'completed' as const,
    featured: true,
    published: true,
    isNew: true,
...
export const getLocalizedProjects = (t: (key: string) => string): Project[] => {
  return projectsBase.map(project => ({
    ...
    demo: project.demo,
    docs: (project as { docs?: string }).docs,
