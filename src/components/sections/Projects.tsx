          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {([
              ...
              <motion.button
                ...
                className={`px-5 py-2.5 text-sm font-medium inline-flex items-center gap-1.5 ${
          ...
          <AnimatePresence>
            {filteredProjects.length === 0 ? (
              <div className="col-span-full text-center py-16">
                <Rocket className="w-16 h-16 mx-auto mb-4 text-ink-faint" />
                <h3 className="text-xl font-semibold font-dev text-ink mb-2">
              ...
              <>{filteredProjects.map((project, index) => (
                <motion.div
                  ...
                  className="card-press-elevated overflow-hidden h-full group"
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 flex flex-col gap-2">
                      {project.isNew && (
                        <span className="bg-success-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg shadow-success-500/30 animate-pulse">
                  ...
                  <div className="p-5">
                    <h3 className="text-lg font-bold font-dev text-ink mb-2">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.slice(0, 3).map((tech) => (
                        <span
                          key={tech}
                          className="rounded-full border border-primary-500/20 bg-primary-500/10 px-3 py-1 text-xs font-medium text-primary-600 dark:text-primary-300"
                        >
                          {tech}
                        </span>
                      ))}
                      ...
                      <div className="mb-4 flex items-center">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${
                          project.status === 'completed'
                            ? 'bg-success-500/15 text-success-600 dark:text-success-300 ring-1 ring-success-500/30'
                            : 'bg-warning-500/15 text-warning-600 dark:text-warning-300 ring-1 ring-warning-500/30'
                        }`}>
                          <span className={`w-1.5 h-1.5 rounded-full ${
                            project.status === 'completed' ? 'bg-success-500' : 'bg-warning-500'
                          }`} />
                      ...
                      <div className="flex gap-2">
                        {project.demo && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 text-ink-faint hover:text-primary-500 transition-colors duration-200 rounded-lg hover:bg-primary-500/10"
                            title="Ver demo"
                          >
          ...
          {selectedProject && (
            ...
            >
              <motion.div
                ...
                className="bg-elevated rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto"
              >
                {(() => {
                  ...
                  return (
                    <div>
                      ...
                      <div className="p-4 md:p-8">
                        <h3 className="text-3xl font-bold font-dev text-ink mb-4">
                          {project.title}
                        </h3>
                        ...
                        <div className="mb-6">
                          <h4 className="font-semibold font-dev text-ink mb-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {project.technologies.map((tech) => (
                              <span
                                key={tech}
                                className="rounded-lg border border-primary-500/20 bg-primary-500/10 px-4 py-2 text-sm font-medium text-primary-600 dark:text-primary-300"
                              >
                                {tech}
                              </span>
                            ))}
                        ...
                        <div className="flex gap-4">
                          {project.demo && (
                            <motion.a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="btn-press btn-press-primary px-6 py-3"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                              </svg>
                          ...
                          {project.docs && (
                            <motion.a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="btn-press btn-press-accent px-6 py-3"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                              </svg>
                              <span>{tString('projects.docs')}</span>
                            </motion.a>
                          )}
                          ...
                          {project.github && (
                            <motion.a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="btn-press btn-press-dark px-6 py-3"
                            >
                              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                              </svg>
